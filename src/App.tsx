  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${isScrolled || isMobileMenuOpen || currentPage !== 'home' ? 'bg-brand/95 backdrop-blur-md border-b border-white/10 py-4' : 'bg-transparent py-6'}`}>
      <div className="max-w-[1800px] mx-auto px-4 md:px-8 flex justify-between items-center relative">
        <div className="flex-none md:flex-1 flex justify-start items-center gap-4">
          <button 
          ...
          <a 
            href="tel:4124926902" 
            className={`sm:hidden transition-colors duration-500 ${isScrolled || isMobileMenuOpen || currentPage !== 'home' ? 'text-ink' : 'text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]'}`}
          >
            <Phone size={20} />
          </a>
        ...
        <div className="flex-none md:flex-1 flex justify-end items-center gap-3 sm:gap-4 lg:gap-8">
          <a 
            href="tel:4124926902" 
            className={`hidden sm:flex transition-colors duration-500 items-center gap-2 ${isScrolled || isMobileMenuOpen || currentPage !== 'home' ? 'text-ink hover:text-zinc-800' : 'text-white hover:text-white/80 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]'}`}
          >
            <span className="text-[11px] lg:text-[13px] font-serif font-semibold tracking-wider whitespace-nowrap">
              (412) 492-6902
            </span>
          </a>
          <button 
